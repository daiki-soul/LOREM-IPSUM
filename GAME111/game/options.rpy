...
define config.name = _('ISEKAI: A lie')
...
define build.name = 'ISEKAI: A lie'
...
## uncomment a line below and use it to set a sample sound to play. heyyy
...
define config.save_directory = "GAME111-1762523947"
